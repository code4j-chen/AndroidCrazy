    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateBn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(DateDialogTest.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        EditText show = (EditText) findViewById(R.id.show);
                        show.setText("您选择了：" + year + "年" + (monthOfYear + 1)
                                + "月" + dayOfMonth + "日");
                    }
        ...
        timeBn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new TimePickerDialog(DateDialogTest.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
